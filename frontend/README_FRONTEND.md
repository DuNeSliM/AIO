...
│   ├── components/
│   │   ├── Sidebar.jsx       # Linke Sidebar mit Dummy-Icons
│   │   ├── GameList.jsx      # Liste der Spiele
│   │   └── GameCard.jsx      # Einzelnes Spiel mit Start-Button
│   ├── pages/
│   │   └── GameLibrary.jsx   # Haupt-Bibliothek-Seite
│   ├── hooks/
│   │   └── useGames.js       # Hook für Spiel-State & API-Calls
│   ├── services/
...
### Neue Sidebar-Icons
Bearbeite [src/components/Sidebar.jsx](src/components/Sidebar.jsx) und füge neue `<DummyIcon>` hinzu.
...
### Weitere Platforms
1. Erweitere `launchGame()` in [src/services/api.js](src/services/api.js)
